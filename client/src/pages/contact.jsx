...
export default function ContactPage() {
  ...
  try {
    const response = await fetch("https://comp229-portfolio-498n.onrender.com/api/contact", {
      method: 'POST',
      headers: {
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">437 928 8036</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">brilljohntorino@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">Scarborough, Ontario, Canada</p>
                  </div>
                </div>
